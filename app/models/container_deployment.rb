...
eos
  ...
  def generate_ansible_inventory
    template = <<eos
[OSEv3:vars]
#{container_deployment_authentications.first.generate_ansible_entry}
...
eos
  ...
  def create_deployment_auth(options)
    container_deployment_authentications << ContainerDeploymentAuthentication.new(:name                                      => options[:auth_name],
