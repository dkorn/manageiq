...
begin
  ...
  result = $evm.root['container_deployment'].run_playbook_command($evm.root['deployment_master'], $evm.get_state_var(:ssh_user), "atomic-openshift-installer -u -c /usr/share/ansible/openshift-ansible/inventory.yaml install")
  if result[:finished]
